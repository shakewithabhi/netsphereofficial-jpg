        ...
        {loading ? (
          ...
          <div className="space-y-1">
            {files.map((file) => (
              <div
                key={file.id}
                className="flex items-center gap-3 px-4 py-3 bg-white border border-slate-100 rounded-xl group hover:bg-slate-50 transition-colors cursor-pointer"
              ...
              >
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-2.5 py-1.5 text-xs font-medium text-amber-600 bg-amber-50 hover:bg-amber-100 rounded-lg transition-colors opacity-0 group-hover:opacity-100"
                >
                  <Star size={14} />
                  Unstar
                </button>
